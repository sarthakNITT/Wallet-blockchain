          ...
          <div className="lg:col-span-1">
            <div className="card-glass p-6 sticky top-24">
              ...
              <div className="space-y-3">
                <Button variant="ghost" className="w-full justify-start p-3 text-white hover:bg-white/10 border border-white/10 hover:border-white/20" onClick={handleCreateAccount}>
